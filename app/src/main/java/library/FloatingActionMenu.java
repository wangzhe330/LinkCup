...
import library.animation.DefaultAnimationHandler;
import library.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    /** Reference to the preferred {@link library.animation.MenuAnimationHandler} object */
    ...
    /**
     * Constructor that takes the parameters collected using {@link library.FloatingActionMenu.Builder}
     ...
     * @param animated if true, this action is executed by the current {@link library.animation.MenuAnimationHandler}
     */
    ...
    /**
     * Toggles the menu
     * @param animated if true, the open/close action is executed by the current {@link library.animation.MenuAnimationHandler}
     */
    ...
    /**
     * A builder for {@link library.FloatingActionMenu} in conventional Java Builder format
     */
