...
/**
 * A simple button implementation with a similar look an feel to{@link library.FloatingActionButton}.
 */
public class SubActionButton extends FrameLayout {
    ...
    /**
     * A builder for {@link library.SubActionButton} in conventional Java Builder format
     */
